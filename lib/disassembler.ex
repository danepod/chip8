defmodule Disassembler do
  ...
  def disassemble(<<8, x, y, 4>>), do: ""
  def disassemble(<<8, x, y, 5>>), do: ""
  def disassemble(<<8, x, y, 6>>), do: ""
  def disassemble(<<8, x, y, 7>>), do: ""
  def disassemble(<<8, x, y, e>>), do: ""
  def disassemble(<<9, x, y, 0>>), do: ""
  def disassemble(<<0xA, n1, n2, n3>>), do: ""
  def disassemble(<<0xB, n1, n2, n3>>), do: ""
  def disassemble(<<0xC, x, n1, n2>>), do: ""
  def disassemble(<<0xD, x, y, n>>), do: ""
  def disassemble(<<0xE, x, 9, 0xE>>), do: ""
  def disassemble(<<0xE, x, a, 1>>), do: ""
  def disassemble(<<0xF, x, 0, 7>>), do: ""
  def disassemble(<<0xF, x, 0, a>>), do: ""
  def disassemble(<<0xF, x, 1, 5>>), do: ""
  def disassemble(<<0xF, x, 1, 8>>), do: ""
  def disassemble(<<0xF, x, 1, 0xE>>), do: ""
  def disassemble(<<0xF, x, 2, 9>>), do: ""
  def disassemble(<<0xF, x, 3, 3>>), do: ""
